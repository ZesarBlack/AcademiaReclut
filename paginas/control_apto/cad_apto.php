                        ...
                        <div class="x_panel tile"  style="border: 2px solid #CABFFF;">
                                ...
                                <div class="row tile_count">
                                  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i> Total Aptos para C3</span>
                                  ...
                                  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    ...
                                    <div class="count blue"><?php $apto->numeroCadeteshombres(); ?></div>
                                    <!--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>-->
                                  </div>
                                  <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
                                    <span class="count_top"><i class="fa fa-user"></i> Total de Mujeres</span>
                                    <div class="count red"><?php $apto->numeroCadetesmujeres(); ?></div>
                                    <!--<span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From last Week</span>-->
                                  </div>
                                </div>
                                <div class="col-md-2">
                                  <form class="" action="apto.php" method="post">
                                    <button type="submit" name="button" class="btn btn-primary">Descargar reporte de aspirantes</button>
                                  </form>
                                </div>
