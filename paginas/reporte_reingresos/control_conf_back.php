...
class ControlConf
{
  public function obtenerConfianza()
  {
    ...
    $query_conf="SELECT * FROM reporte_reingresos";
  ...
  {
    include '../../requires/conexion.php';
    $query_act="INSERT INTO reporte_reingresos(estatus_cup, observaciones, num_control) values ('$estatus', '$observacion', '$control')";
